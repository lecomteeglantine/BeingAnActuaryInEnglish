(() => {
  'use strict';
  // M1 Session 2 museum engine · R9 mega functional audit

  const STORAGE_KEY = 'being-an-actuary-m1-session2-museum-r9';
  const LEGACY_KEYS = ['being-an-actuary-m1-session2-museum-r8','being-an-actuary-m1-session2-museum-r7','being-an-actuary-m1-session2-museum-r6','being-an-actuary-m1-session2-museum-r5','being-an-actuary-m1-session2-museum-r4','being-an-actuary-m1-session2-museum-r3','being-an-actuary-m1-session2-museum-r2','being-an-actuary-m1-session2-museum-r1'];
  const MAX_SCORE = 32;
  const galleryThumbs = [
    'assets/session2-museum/gallery1-birth.svg?v=r9',
    'assets/session2-museum/gallery2-probability.svg?v=r9',
    'assets/session2-museum/gallery3-radicals.svg?v=r9',
    'assets/session2-museum/gallery4-final.svg?v=r9'
  ];
  ...
  const galleries = [
    {
      ...
      objects: [
        ['assets/session2-museum/ethical-society.svg?v=r9', 'Early insurance society'],
        ['assets/session2-museum/mores-title.svg?v=r9', 'The title “actuary”'],
        ['assets/session2-museum/morgan-ledger.svg?v=r9', 'Professional actuarial work']
      ],
      featuredQuestion: 0,
    ...
    },
    {
      ...
      objects: [
        ['assets/session2-museum/bayes-price.svg?v=r9', 'Bayes & Price manuscript'],
        ['assets/session2-museum/mortality-table.svg?v=r9', 'Population table'],
        ['assets/session2-museum/premium-ledger.svg?v=r9', 'Premium ledger']
      ],
      featuredQuestion: 0,
    ...
    },
    {
      ...
      objects: [
        ['assets/session2-museum/price-pamphlet.svg?v=r9', 'Price’s political writing'],
        ['assets/session2-museum/letters-network.svg?v=r9', 'Atlantic correspondence'],
        ['assets/session2-museum/priestley-science.svg?v=r9', 'Science & dissent']
      ],
      featuredQuestion: 1,
    ...
    },
    {
      ...
      objects: [
        ['assets/session2-museum/concept-wheel.svg?v=r9', 'Ideas connected'],
        ['assets/session2-museum/gallery4-final.svg?v=r9', 'Four-frame wall'],
        ['assets/session2-museum/museum-hero.svg?v=r9', 'Opening night']
      ],
      featuredQuestion: 0,
  ...
  const sfxAssets = {
    on: 'assets/session2-museum/audio/sound-on.wav?v=r9',
    select: 'assets/session2-museum/audio/select.wav?v=r9',
    save: 'assets/session2-museum/audio/save.wav?v=r9',
    complete: 'assets/session2-museum/audio/gallery-complete.wav?v=r9',
    final: 'assets/session2-museum/audio/final.wav?v=r9',
    timer: 'assets/session2-museum/audio/timer.wav?v=r9',
    attention: 'assets/session2-museum/audio/attention.wav?v=r9'
  };
  ...
  function renderFinal() {
    ...
    finalView.innerHTML = `
      <div class="final-hero">
        <img src="assets/session2-museum/gallery4-final.svg?v=r9" alt="Four framed exhibits on the final museum wall.">
    ...
    const updateScriptStats = () => {
      ...
      $('finalWordCount').textContent = `${words} words · target 160–210`;
      $('finalTimeEstimate').textContent = `Estimated speaking time: ${formatTime(sec)} at ~125 words/min`;
      $('finalTimeEstimate').className = (sec > 105 || words > 210) ? 'timer-warning' : '';
      $('finalTimeEstimate').title = (sec > 105 || words > 210) ? 'Trim the script to leave time for pauses and speaker handovers.' : 'This estimate leaves room for natural pauses if you keep a steady pace.';
    };
    updateScriptStats();
