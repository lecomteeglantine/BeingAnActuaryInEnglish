const CACHE='actuarial-english-2026-09-03-r6-audit-fix';
const CORE=[
  ...
  './assets/session1/individual-hero.svg','./assets/session1/security-gate.svg','./assets/session1/case-files.svg','./assets/session1/risk-lab.svg','./assets/session1/elevator.svg','./assets/session1/group-hero.svg','./assets/session1/firm-board.svg'
];
