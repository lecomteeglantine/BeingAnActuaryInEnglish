...
5. After GitHub Pages finishes deploying, refresh the site. The service worker uses a new cache version so the corrected files replace the previous deployment.
